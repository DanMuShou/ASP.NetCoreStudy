...
using ContactsManagerSolution.Filters;
using ContactsManagerSolution.Filters.ActionFilters;
using ContactsManagerSolution.Filters.AuthorizationFilter;
using ContactsManagerSolution.Filters.ExceptionFilter;
using ContactsManagerSolution.Filters.ResourceFilter;
...
) : Controller
{
    ...
    public async Task<IActionResult> Create()
    {
        ...
        var countryResponseList = await countriesGetterService.GetAllCountries();
